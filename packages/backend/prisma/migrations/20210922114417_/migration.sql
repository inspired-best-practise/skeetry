/*
  ...
  - The values [ANTARCTICA] on the enum `Continent` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Continent_new" AS ENUM ('ASIA', 'AFRICA', 'AMERICAS', 'POLAR', 'EUROPE', 'OCEANIA', 'ISLAND');
